  ...
  return (
    <AdminLayout title="新規ページ">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white">新規ページ作成</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-between items-center pt-6 border-t border-gray-200 dark:border-gray-700">
            ...
            <button
              type="submit"
              disabled={isSaving || !pageData.title.trim() || !pageData.slug.trim()}
